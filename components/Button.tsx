...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    [ComponentVariant.PRIMARY]: "bg-white text-black shadow-lg shadow-white/10 hover:bg-slate-200 hover:-translate-y-0.5",
    [ComponentVariant.SECONDARY]: "bg-black text-white border border-white/10 hover:bg-white/5 hover:border-white/30",
