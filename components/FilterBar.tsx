          ...
          <div className="flex flex-wrap items-center gap-4 w-full lg:w-auto justify-center lg:justify-start">
            ...
            <div className="relative group">
              <select 
                ...
                className="appearance-none bg-white/5 border border-white/10 text-white text-sm px-4 py-2 pr-10 rounded-lg focus:outline-none focus:border-white transition-colors cursor-pointer min-w-[160px]"
              >
            ...
            <div className="relative group">
             ...
             <div className="flex items-center gap-3 px-4 border-l border-white/10">
                <span className="text-xs text-slate-500 uppercase">Max Price</span>
          ...
          <div className="flex items-center gap-3 w-full lg:w-auto justify-end">
            <label className="flex items-center gap-2 cursor-pointer group">
              <div className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${
                showPreOrder ? 'bg-white border-white' : 'border-slate-600 bg-transparent group-hover:border-slate-400'
              }`}>
                {showPreOrder && <svg className="w-3 h-3 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7" /></svg>}
              </div>
              <input 
                type="checkbox" 
                className="hidden" 
